package com.facci.proyectojcdc;
...
public class MainActivityJCDC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity_jcdc);
    ...
    public void InsetarBtn (View v) {
        ...
        if (Insertadatos) {
            Toast.makeText(MainActivityJCDC.this, "Datos Ingresados", Toast.LENGTH_SHORT).show();
        }else{Toast.makeText(MainActivityJCDC.this,"Datos no Ingresados ocurrio un error",Toast.LENGTH_SHORT).show();}
    }
    ...
    public void Modificar (View v) {
        ...
        if(ActualizandoDatos)
            ...
            Toast.makeText(MainActivityJCDC.this,"Lo sentimos ocurrió un error",Toast.LENGTH_SHORT).show();
    ...
    public void Eliminar (View v) {
        ...
        if(registrosEliminados > 0 ){
            Toast.makeText(MainActivityJCDC.this,"Registro(s) Eliminado(s)",Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(MainActivityJCDC.this,"ERROR: Registro no eliminado", Toast.LENGTH_SHORT).show();
        }
    }
